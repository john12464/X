...
const Cubes = ({
  ...
  const colGap =
    typeof cellGap === "number"
      ? `${cellGap}px`
      : (cellGap as { col?: number; row?: number })?.col !== undefined
        ? `${(cellGap as { col?: number; row?: number }).col}px`
        : "5%";
  const rowGap =
    typeof cellGap === "number"
      ? `${cellGap}px`
      : (cellGap as { col?: number; row?: number })?.row !== undefined
        ? `${(cellGap as { col?: number; row?: number }).row}px`
        : "5%";
